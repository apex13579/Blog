...
* [ ] **Jeremy's IT Lab CCNA Complete Course (YouTube)**
* [ ] **Cisco U. CCNA Learning Path**
* [ ] **Cisco CCNA (Cisco Certified Network Associate)** *(Renewable via 30 CEUs)*
...
* [ ] **FreeCodeCamp: Complete Certifications Stack**
  ...
  * [ ] **Go — Learn Go with Tests (GitHub, Free)**
    * [ ] **Full Courses — FreeCodeCamp (YouTube)**
...
* [ ] **Cisco U. Cybersecurity Associate Path**
